...
def gban(update: Update, context: CallbackContext):
    ...
    message.reply_text("Sharingan 𖣘 . . .")
    ...
    if gban_time > 60:
        ...
        message.reply_text("This User Is Now Under My Genjustu", parse_mode=ParseMode.HTML)
    else:
        message.reply_text("This User Is Now Under My Genjustu", parse_mode=ParseMode.HTML)
